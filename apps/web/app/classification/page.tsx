  ...
  return <div>
    <section className="page-width hero">
      <div className="hero-copy"><h1>Can a fly’s brain<br/>spot your <em>secrets?</em></h1>
        ...
        <div className="hero-actions"><a className="button button-dark" href="#experiment">Try the experiment</a><Link className="text-link" href="/benchmark">Read the results</Link></div>
      </div>
