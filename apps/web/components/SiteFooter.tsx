...
export function SiteFooter() {
  return <footer className="site-footer"><div className="page-width footer-inner">
    ...
    <div><Link href="/dreaming-method">Data &amp; method</Link><a href="https://github.com/zgbrenner/legalflyapp" target="_blank" rel="noreferrer"><span className="with-icon">Source code <ExternalIcon/></span></a></div>
